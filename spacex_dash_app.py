...
def get_pie_chart(site_dropdown):
    if site_dropdown == 'ALL' :
        ...
        filtered_df = spacex_df[site_dropdown]
        filtered_df = spacex_df.loc[spacex_df['Launch Site'] == site_dropdown]
        fig = px.pie(data_frame= filtered_df, names = 'class', title = 'Total Launch for specific site')
        return fig
# TASK 4:
...
def update_graph(site_dropdown,payload_slider) :
    if site_dropdown == 'ALL' :
        ...
        fig = px.scatter(data_frame= filtered_data, color ='Boosster Version Category',
        x= 'Payload Mass (kg)', y= 'class')
        return fig
# Run the app
